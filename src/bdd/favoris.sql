...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 23 jan. 2024 à 10:41
...
(26, 'PostMan', '2024-02-05', 'https://www.postman.com/', 5),
(27, 'XMLHttpRequest – Doc officielle', '2024-02-07', 'https://developer.mozilla.org/fr/docs/Web/API/XMLHttpRequest#constructeur', 5),
(28, 'Fetch API  Pierre Giraud', '2024-02-08', 'https://www.pierre-giraud.com/javascript-apprendre-coder-cours/api-fetch/', 5),
(29, 'Vidéo XMLHttpRequest', '2024-02-09', 'https://www.youtube.com/watch?v=Bct585a0Hj8', 5),
(30, 'La méthode Fetch (6 min)', '2024-02-12', 'https://www.youtube.com/watch?v=sGvEqHkDyFc', 5);
